    ...
    <div style={{
      ...
      {!submitted ? (
        <form onSubmit={handleSubmit} style={{
          ...
          <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: '#f8fafc' }}>Stay Updated with SMS</h2>
          <p style={{ fontSize: '0.9rem', color: '#cbd5e1', marginBottom: '1.5rem', lineHeight: '1.4' }}>
            Enter your mobile phone number to opt-in and receive updates about available delivery routes, dispatch assignments, and onboarding information from Liberty Dispatchers.
          </p>
          ...
          <div style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
            <input
              ...
              required
              style={{ marginTop: '0.25rem', width: '1.25rem', height: '1.25rem', flexShrink: 0 }}
            />
        ...
        <div style={{
          ...
          <p style={{ color: '#94a3b8' }}>You have successfully opted into text messaging alerts.</p>
        </div>
      )}
